class AppImageAsset{
  ...
  static const String onBoardingImageOne   = "$rootImages/onboarding2.png";
  static const String onBoardingImageTwo   = "$rootImages/onboarding1.png";
  static const String onBoardingImageThree = "$rootImages/onboarding.png";
